...
fn snapshot_params(params: &KickForgeParams) -> KickForgePacket {
    KickForgePacket {
        ...
        body_feedback: params.body_feedback.value(),
        body_hold: params.body_hold.value(),
        body_split_freq: params.body_split_freq.value(),
...
fn spawn_windows(
    ...
    let webview = match wry::WebViewBuilder::with_web_context(&mut web_context)
        ...
        // Ctrl+R / F5 / F12 / Ctrl+Shift+I) at the OS level.
