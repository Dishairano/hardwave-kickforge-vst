...
pub fn factory_presets() -> Vec<Preset> {
    vec![
        ...
        // ── Classic Hardstyle: standard reverse bass kick ───────────────────
        make_preset("Classic Hardstyle", &[
            ...
            ("body_pitch_start", 900.0),
            ("body_pitch_end", 55.0),
            ("body_pitch_decay", 180.0),
        ...
        // ── Raw Hardstyle: aggressive, lots of foldback, long tail ──────────
        make_preset("Raw Hardstyle", &[
            ...
            ("body_pitch_start", 1200.0),
            ("body_pitch_end", 48.0),
            ("body_pitch_decay", 220.0),
            ("body_pitch_curve", 4.0),   // Punch
            ("body_waveform", 4.0),      // SineFold
            ("body_drive", 0.8),
            ("body_distortion_type", 2.0), // Foldback
            ("body_decay", 1200.0),
            ("body_volume", 1.0),
            ("body_tone", 5000.0),
            ("body_resonance", 0.3),
        ...
        // ── Hardcore / Gabber: very fast sweep, high drive, short ───────────
        ...
        // ── Industrial: bitcrush + hard clip, metallic ──────────────────────
        ...
        // ── Deep Kick: slow sweep, clean, heavy sub ─────────────────────────
        ...
        // ── Minimal Techno: short, punchy, less distortion ──────────────────
        make_preset("Minimal Techno", &[
            ...
            ("click_decay", 4.0),
            ("click_filter_freq", 6000.0),
            ("body_pitch_start", 400.0),
            ("body_pitch_end", 55.0),
            ("body_pitch_decay", 80.0),
            ("body_pitch_curve", 0.0),   // Exponential
            ("body_waveform", 0.0),      // Sine
            ("body_drive", 0.1),
            ("body_distortion_type", 0.0), // Tanh
        ...
        // ── Donk: very fast sweep, bright click, bouncy ────────────────────
        make_preset("Donk", &[
            ("click_enabled", 1.0),
            ("click_type", 2.0),        // Punch
            ("click_volume", 0.95),
            ("click_pitch", 9000.0),
            ("click_decay", 3.0),
            ("click_filter_freq", 15000.0),
            ("body_pitch_start", 3000.0),
            ("body_pitch_end", 60.0),
